...
extern cbuf_handle_t cbufRx; ///< Circular buffer handler for receiving characters


// Assume the circular buffer handle and the semaphore are declared globally
extern SemaphoreHandle_t rxSemaphore;  // Semaphore to notify when data is available
